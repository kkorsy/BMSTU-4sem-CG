...
def add_symmetric_pixels(points, dot, xc, yc, circle=True):
    if circle:
...
def bresenham_int(beg_point, end_point):
...
def bresenham_circle(xc, yc, r):
    ...
    points = list()
    add_symmetric_pixels(points, [x + xc, y + yc], xc, yc, circle=True)
...
def bresenham_ellipse(xc, yc, ra, rb):
    ...
    add_symmetric_pixels(points, [x + xc, y + yc], xc, yc, circle=False)
